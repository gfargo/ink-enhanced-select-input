...
| `autoSelectFirstEnabled` | `boolean`                                   | `true`                        | Fall back to the first enabled item when no initial target resolves. `false` starts with no highlight until the user navigates                                       |
