...
## [1.3.0](https://github.com/gfargo/ink-enhanced-select-input/compare/ink-enhanced-select-input-v1.2.0...ink-enhanced-select-input-v1.3.0) (2026-08-11)
...
* onCancel/Escape, Home/End keys, and bug fixes ([#19](https://github.com/gfargo/ink-enhanced-select-input/issues/19)) ([d459214](https://github.com/gfargo/ink-enhanced-select-input/commit/d45921417dc3593b91a6f612a05d811e21a545c8))
...
* **group-header:** emit header on adjacency change, not set membership ([#95](https://github.com/gfargo/ink-enhanced-select-input/issues/95)) ([265febc](https://github.com/gfargo/ink-enhanced-select-input/commit/265febcbf90838f389044cffaa4e8d150fee9208)), closes [#66](https://github.com/gfargo/ink-enhanced-select-input/issues/66)
...
* **home-end:** no-op Home/End when all items are disabled ([#33](https://github.com/gfargo/ink-enhanced-select-input/issues/33)) ([5f27a91](https://github.com/gfargo/ink-enhanced-select-input/commit/5f27a91b82e5179cdfa86b455d17843f94374620))
...
* limit prop now paginates — all items reachable via navigation ([a8287ff](https://github.com/gfargo/ink-enhanced-select-input/commit/a8287ff24ff09ff6e44f82cff835a176e6800a3b))
...
* **navigation:** fix findLastValidIndex empty-list edge case and add helper unit tests ([#32](https://github.com/gfargo/ink-enhanced-select-input/issues/32)) ([9c5b51c](https://github.com/gfargo/ink-enhanced-select-input/commit/9c5b51ce01b5c010907ccdfd556cb1bb331032ff))
...
* skip disabled items when resolving initialIndex ([9375e32](https://github.com/gfargo/ink-enhanced-select-input/commit/9375e32c2f9d8b1468d97128bdad2e0f59fce6b6))
